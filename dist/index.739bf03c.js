...
var _slimSelectJs = require("./slim-select.js");
var _slimSelectJsDefault = parcelHelpers.interopDefault(_slimSelectJs);
...
const displayCatInfo = async (breedId)=>{
    ...
    try {
        const response = await (0, _catApiJs.fetchCatByBreed)(breedId);
        ...
        (0, _notiflixDefault.default).Notify.Failure("Oops! Something went wrong. Please try again.");
    } finally{
        hideLoader();
    }
};
selectElement.addEventListener("change", (event)=>{
    ...
    if (selectedBreedId) displayCatInfo(selectedBreedId);
});
(0, _slimSelectJsDefault.default)((0, _catApiJs.fetchBreeds), ()=>{
    (0, _notiflixDefault.default).Notify.Failure("Oops! Something went wrong while fetching the breeds. Please try again.");
});

},{"./cat-api.js":"5IWAT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./slim-select.js":"lDKs6","notiflix":"5z0Oc"}],"5IWAT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_0E5x8jdCKMbi1c183G5nEN0dasXbtPsXcjYussnwbwZa4Ti1yZEPAkgeFAFlbGoC";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lDKs6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const loadBreeds = async (fetchFunction, instance)=>{
    ...
    try {
        ...
        (0, _notiflixDefault.default).Notify.Failure("Failed to load breeds. Please try reloading the page.");
    }
};
const initializeSlimSelect = (fetchFunction)=>{
    const slimSelectInstance = new (0, _slimSelectDefault.default)({
        select: ".breed-select"
    });
    loadBreeds(fetchFunction, slimSelectInstance);
};
exports.default = initializeSlimSelect;

},{"slim-select":"lzHUr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","slim-select/dist/slimselect.css":"6O4cs","notiflix":"5z0Oc"}],"lzHUr":[function(require,module,exports) {
...
},{}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequireabb0")
